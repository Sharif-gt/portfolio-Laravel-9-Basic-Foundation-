    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <form class="" method="POST" action="{{route('update.blog',$data->id)}}" enctype="multipart/form-data">
                     @csrf
                        ...
                        <div class="col-md-12">
                            <div class="mb-3 position-relative">
                                ...
                                <select class="form-select" name="categorie_id" aria-label="Default select example">
                                    ...
                                    <option value="{{$item->id}}"{{$item->id == $data->categorie_id ? 'selected' : ''}}>{{$item->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('title')
                       ...
                       <div class="col-md-12 m-3">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3 position-relative">
                                ...
                                <input type="text" class="form-control" id="validationTooltip01" name="tag" value="{{$data->tag}}" data-role="tagsinput">
                            </div>
                            @error('name')
                                <span class="alert-danger">{{$message}}</span>
                            @enderror
                    ...
                    <div>
                        <a href="#"><button class="btn btn-primary" type="submit">Update Blog</button></a>
                    </div>
                </form>
            </div>
        </div>
